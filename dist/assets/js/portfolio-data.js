...
const portfolioProjects = [
...

  {
    ...
    description: "The BetInvest stand was designed in the company’s black and orange colours, making it bright and highly visible on the exhibition floor. The stand includes two meeting areas: one open and one enclosed.\n\nA key part of the design is the repeated use of circular elements. They appear both in the complex suspended structure above the stand and in the round decorative openings integrated into the stand itself. The complex suspended structure is built entirely from screens.\n\nCustom-made lighting was produced specifically for this project, along with bespoke furniture, including sofas and armchairs.",
    category: "custom",
  ...
  },
  {
    ...
    description: "The stand was created for SpetsTechnoExport for Eurosatory in Paris. One of the key technical decisions was to keep the suspended structure below one tonne, so that it did not require a separate structural calculation and the associated additional cost for the client.\n\nThe stand features the Ukrainian coat of arms, suspended models of the client’s products, a large enclosed meeting room and integrated LED lighting. The stand was finished in paint.",
    category: "custom",
  ...
  },
  {
    ...
    description: "This group stand for a Swedish company was created for ReBuild Ukraine in Warsaw. The stand is divided into three sections and designed in light colours to give the whole space a light and natural feel.\n\nWooden slats were selected to match the colour of the counters used on the stand. The overall design was developed to look light and environmentally conscious, with the timber elements helping to create that impression.",
    category: "custom",
  ...
  },
  {
    ...
    description: "The Sklad Service project was a two-storey stand that required a structural calculation. The project was split across two separate locations: the main two-storey stand and another stand opposite it with a suspended structure.\n\nThe design was developed to reflect the character of the company. Its architectural language has an intentionally industrial feel, with references to a warehouse or hangar.",
    category: "custom",
