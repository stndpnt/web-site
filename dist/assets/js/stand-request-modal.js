...
(function () {
  ...
  .srm-submit{appearance:none;border:0;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:10px;min-height:52px;background:#F29311;color:#0b0b0c;font-family:var(--sans,'Inter',sans-serif);font-weight:600;font-size:14px;letter-spacing:.02em;line-height:1.2;text-transform:none;padding:16px 26px;border-radius:2px;transition:background .2s,color .2s;width:100%}
